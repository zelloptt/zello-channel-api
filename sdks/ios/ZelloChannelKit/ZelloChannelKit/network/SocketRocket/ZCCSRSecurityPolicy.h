...
@interface ZCCSRSecurityPolicy : NSObject

/**
 A default `ZCCSRSecurityPolicy` implementation specifies socket security and
 validates the certificate chain.

 Use a subclass of `ZCCSRSecurityPolicy` for more fine grained customization.
 */
...
/**
 ...
 you're free to override it in a subclass. See `ZCCSRPinningSecurityPolicy.h` for
 an example.
