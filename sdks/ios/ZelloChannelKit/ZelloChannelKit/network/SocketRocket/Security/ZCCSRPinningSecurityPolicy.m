...
#import "ZCCSRPinningSecurityPolicy.h"
...
@interface ZCCSRPinningSecurityPolicy ()

@property (nonatomic, copy, readonly) NSArray *pinnedCertificates;

@end

@implementation ZCCSRPinningSecurityPolicy
...
{
    ZCCSRDebugLog(@"Pinned cert count: %d", self.pinnedCertificates.count);
