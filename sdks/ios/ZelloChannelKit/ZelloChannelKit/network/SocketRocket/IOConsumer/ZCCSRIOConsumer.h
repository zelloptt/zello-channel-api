...
@class ZCCSRWebSocket; // TODO: (nlutsenko) Remove dependency on SRWebSocket here.

// Returns number of bytes consumed. Returning 0 means you didn't match.
// Sends bytes to callback handler;
typedef size_t (^stream_scanner)(NSData *collected_data);
typedef void (^data_callback)(ZCCSRWebSocket *webSocket,  NSData *data);

@interface ZCCSRIOConsumer : NSObject {
